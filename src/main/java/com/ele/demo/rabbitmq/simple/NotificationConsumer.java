...
public class NotificationConsumer {
    ...
    // 以 Map 代替真實 DB
    private static final Map<Integer, String> userNameMap = Map.of(1, "ele", 2, "LeeAYoung");
    private static final Map<Integer, String> postNameMap = Map.of(1, "2023 週年慶", 2, "iPhone 15 週邊上架");
